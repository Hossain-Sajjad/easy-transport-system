...
const Banner = () => {
    return (
        <div className="hero lg:min-h-screen mt-0">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img className='lg:w-3/6' src="https://images.hogeschoolrotterdam.nl/Blob/fe19d708e4294dc18c4984a16e4fa086/e67c2cc4d8354aa180283afded94ece7.jpg?width=1200&height=630&mode=crop" alt='' />
                <div>
